...
- **Redis Host:** `your-redis-host.cloud.redislabs.com`
- **Redis Port:** `your-port`
...
```
your-redis-host.cloud.redislabs.com==>your-redis-host.cloud.redislabs.com
your-redis-password==>your-redis-password
regex:REDIS_PORT=your-port==>REDIS_PORT=your-port
```
...
```
your-redis-host.cloud.redislabs.com
your-redis-password
your-port
```
...
git grep "redis-your-port"
git grep "your-redis-password"
```
...
```bash
# Should return nothing
git log -S "redis-your-port" --all
git log -S "your-redis-password" --all

# Or use this one-liner
git grep "redis-your-port" $(git rev-list --all) || echo "✅ No secrets found!"
```
...
git log -p --all | grep -i "redis-your-port" || echo "✅ Clean!"
```
...
4. Check for secrets: `git log -S "redis-your-port" --all`
